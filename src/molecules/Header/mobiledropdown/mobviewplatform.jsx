   ...
   const setplatformpage=props.setplatformpage
     ...
     return(
        <>
        {
          platformpage&&(
              ...
              <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow"  onClick={()=>{setData(true);setplatformpage(false);}}/></div>
                  <h5 className={Style.head}>{data.menuItems[0].name}</h5>
                  
                  <div className={Style.content}> {data.menuItems[0].list.map((item) => (
              ...
              <h5 className={Style.head}>Marketplaces</h5>
              <ul className={Style.listitems} 
                       >
                      <div id={Style.content}><li>Public Marketplaces</li></div>
                  ...
                  <ul className={Style.listitems} 
                       >
                      <div id={Style.content}><li>Private Marketplaces</li></div>
             ...
             <div id={Style.hrline}><hr></hr></div>
               ...
               <div id={Style3.firstprinciples}>
               <div className={Style3.head}> <h5 >First Principles</h5> </div> 
                <div className={Style3.rightarrow} onClick={()=>{setdata2(data.menuItems[3]);setpage2(true);setplatformpage(false)}}><img src={images.RightArrow} alt="rightarrow"/></div>
                </div> 
              </div>
    </div>
          )
    ...
    {page2 &&(
      <div className={Style2.menu}>
                        ...
                        <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow" onClick={()=>{setplatformpage(true);setpage2(false)}}/></div>
                    <h5 class={Style.head}>{data2.name}</h5>
                    <div>
                    { data2.list.map((item)=>(
                    <ul class={Style.listitems}  
                    //onClick={()=>{setdata3(item.content);setpage2(false);setpage3(true)}}
                    ><div id={Style.content} onClick={()=>{changeRoute(item.article.url);setpage2(false)}}><li>{item.name}</li></div>
      ...
      {page3&& (
                     ...
                     <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow"
                      onClick={()=>{
                     ...
                     /></div>
                                   ...
                                   <div class={Style.arrowfolder}><div><h6><b>Learn More</b></h6></div><div class={Style.arrow} onClick={()=>{changeRoute(data4.url);setpage3(false)}}><FiArrowRight /></div></div>
