export const accordianData = [
  ...
  },
  {
    ...
    sections: [
      {
        items: [
          "Rebalancing in thematic investing involves adjusting the allocation of assets within a portfolio to maintain the desired exposure to specific themes or trends.",
