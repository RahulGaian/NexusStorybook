        ...
        >
          <div className={Style.cont1}>
            ...
            <div class={Style.botcont1}>
              {/* <div>
                <h5 class={Style.head}>{data[0].menuItems[3].name}</h5>
              </div>
              <div>
            ...
            <div className={Style.topcont1}>
              ...
              <div className={Style2.marketplace}>
                <div className={Style2.public}>
                  <div class={Style2.platformhead}>
                    {" "}
                    <h5>{data[0].menuItems[1].name}</h5>
                  </div>
                  <div>
                    {data[0].menuItems[1].list.map((item) => (
                      <ul
                        className={Style2.listitemsplatform}
                        onMouseEnter={() => {
                          setdata3(item.article);
                          setisdata3(true);
                        }}
                      >
                        <div
                          className={Style2.contentplatform}
                          onClick={() => {
                            changeRoute(item.article.url);
                          }}
                        >
                        ...
                        <div className={Style2.rightarrowplatfrom}>
                          <Img src={images.RightArrow} alt="rightarrow" />
                        </div>
                      </ul>
                    ))}
                  ...
                  <div>
                    {data[0].menuItems[2].list.map((item) => (
                      ...
                      >
                        ...
                        <div className={Style2.rightarrowplatform}>
                          <Img src={images.RightArrow} alt="rightarrow" />
                        </div>
                      </ul>
                    ))}
