...
{productspage1 && (
    <div className={Style2.menu}>
        ...
        <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow"  onClick={()=>{setData(true);setprodpage(false)}}/></div>
            <h5 className={Style.head}>{data.menus[0].name}</h5>
            ...
            {page2 && (
                <div className={Style2.menu}>
                    ...
                    <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow" onClick={()=>{setprodpage(true);setpage2(false)}}/></div>
                        <h5 class={Style.head}>{data2[0].name}</h5>
                        <div>
                            {data2[0].items.map((item) => (
                                <ul class={Style.listitems}>
                                    <div id={Style.content} onClick={() => { changeRoute(item.content.url); setpage2(false) }}>
                                        <li>{item.name}</li>
                                    </div>
            ...
            {page4 && (
                <div className={Style2.menu}>
                    <div id={Style.page2content} >
                    <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow" onClick={()=>{setpage4(false);setpage2(true)}}/></div>
                        <h5 class={Style.head}>{data4name}</h5>
                        <div>
                            {data4.map((item) => (
                                <ul class={Style.listitems} >
                                    <div id={Style.content} onClick={() => { changeRoute(item.content.url); setpage4(false) }} >
                                        <li>{item.name}</li>
                                    </div>
            ...
            {page3 && (
                <div className={Style2.menu}>
                    ...
                    <div id={Style2.returnarrow}><img src={images.leftarrow} alt="returnarrow" onClick={()=>{setpage3(false);setpage4(true)}}/></div>
                        <div>
                        ...
                        <div class={Style.arrowfolder}>
                            ...
                            <div class={Style.arrow} onClick={() => { changeRoute(data3.url); setpage3(false) }}><FiArrowRight /></div>
                        </div>
