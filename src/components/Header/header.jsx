    ...
    <div className={Style.header}>
          <div className={isScrolled? Style.navbar2:Style.navbar1} onMouseEnter={()=>{setIsOpen(false)}} >
            <div className={Style.headercomponents}>
              ...
              <div className={Style.logo} onClick={()=>{ window.location.href="/"}}><img  src={process.env.PUBLIC_URL + "/images/Nexus_connect/landingpage/logo1.svg"}  alt='nexuslogo'></img></div>   
              {!isplatform?
              ...
              <div id={Style.login} onClick={handlelogin}  ><span>Login</span><span ><img  src={images.DownArrow} alt='vector' style={{ transform: `rotate(${rotation}deg)`,transition: 'transform 0.5s ease', }}
              ></img></span></div> 
              </div>
            </div>
